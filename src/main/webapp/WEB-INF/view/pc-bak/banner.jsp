...
<div class="layui-carousel" id="test1" style="margin-bottom: 20px;">
    <div carousel-item>
        ...
        <div style="background-image: url('${ctx}/static/img/6.jpg');background-size:100% 100%; "></div>
        <div style="background-image: url('${ctx}/static/img/7.jpg');background-size:100% 100%; "></div>
    </div>
</div>
